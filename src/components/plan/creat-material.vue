  ...
  <div id="creatmaterial">
    ...
    <div class="material">
      ...
      <div class="con">
        ...
        <tpl-image :collapseVal.sync="collVal" :adCon="adCon.image" :editRule="materialRule" :canSave="canSave" :canEdit="canEdit"></tpl-image>
        <tpl-relation1 :collapseVal.sync="collVal" :adCon="adCon.relation1" :editRule="materialRule" :canSave="canSave" :canEdit="canEdit"></tpl-relation1>
        <tpl-relation2 :collapseVal.sync="collVal" :adCon="adCon.relation2" :editRule="materialRule" :canSave="canSave" :canEdit="canEdit"></tpl-relation2>
      </div>
    </div>
...
import materialRule from '../../../static/json/materialRule.json'
// 素材模板
...
export default {
  ...
  methods: {
    ...
    chooseMedia (actId, mediaId, index, status, statusDesc, canClick) {
      console.log(actId, mediaId, index, status, statusDesc, canClick)
      this.materialRule = materialRule[mediaId]
      if (!canClick) return
      // 根据状态判断是否可修改
